      ...
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-between">
          <div>
            ...
            <p class="lead my-4">
              Hello, and welcome to my portfolio website.  My name is Vince Hartman and I attended a coding program through MIT xPRO where I have received a Professional Certificate in Coding: Full Stack Development with MERN.
            </p>
            <br />
