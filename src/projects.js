...
export function Projects() {
    return(
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md">
                    <img src={Pacman} alt="pacman project" class="img-fluid" />
                </div>
                <div class="col-md p-5">
                    ...
                    {/* <a href="https://github.com/vhartman11/Pacman"><i class="bi bi-github text-dark mx-1" style="font-size: 2rem">
                    </i></a>
                    <a href="#"><i class="bi bi-play text-dark mx-1" style="font-size: 3rem">
                    </i></a> --> <!-- this will become a button to link this project to a running webpage --> */}
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="d-sm-flex align-items-center justify-content-between">
                <div class="col-md p-5">
                    ...
                    {/* <a href="https://github.com/vhartman11/Eyes"><i class="bi bi-github text-light mx-1" style="font-size: 2rem">
                    </i></a>
                    <!-- <a href="#"><i class="bi bi-play text-dark mx-1" style="font-size: 3rem">
                </i></a> --> <!-- this will become a button to link this project to a running webpage --> */}
                </div>
    ...
    <section id="3rd project" class="p-5">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md">
                <img src={Map} alt="bus map project" class="img-fluid" />
                </div>
                <div class="col-md p-5">
                    ...
                    {/* <a href="https://github.com/vhartman11/bus-tracker"><i class="bi bi-github text-dark mx-1" style="font-size: 2rem">
                    </i></a>
                    <!-- <a href="#"><i class="bi bi-play text-dark mx-1" style="font-size: 3rem">
                    </i></a> --> <!-- this will become a button to link this project to a running webpage --> */}
                </div>
